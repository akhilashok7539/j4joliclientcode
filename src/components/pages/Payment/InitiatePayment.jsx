...
const InitiatePayment = ({ getValidity, buttonText }) => {
  //* To use call back to update validity
  const delayedGetValidity = useCallback(() => setTimeout(getValidity, 5000), [getValidity]);
  ...
  useEffect(() => {
    return () => {
      clearTimeout(delayedGetValidity);
    };
  }, [delayedGetValidity]);
